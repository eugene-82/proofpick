    ...
    <section className="section-rule" aria-labelledby="source-title">
      <div className="flex flex-wrap items-end justify-between gap-3">
        <div>
          ...
          <h3 className="mt-2 text-xl font-semibold tracking-[-0.02em] text-[#18211d]" id="source-title">확인한 출처</h3>
        </div>
        <p className="metadata">중복 URL을 제외한 {uniqueSources.length}개 출처</p>
      </div>
      <p className="mt-3 text-sm leading-6 text-[#657068]">각 주장에 연결된 공개 원문입니다. 커뮤니티 글과 전문 리뷰를 동일한 provenance 기록으로 표시합니다.</p>
